...
class ValidNFCe
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        if ($destinatario != null) $errArr = $this->validaDestinatario($destinatario, $errArr);
    ...
    {
        if (!isset($documento['numero_nfce']) || $documento['numero_nfce'] == 0) {
            array_push($errArr, "Numero de NFC-e inválido");
        }
